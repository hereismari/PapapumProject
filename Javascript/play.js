$(document).ready(function(){
  ...
  $('div').on('click', function() {
    ...
    document.body.style.backgroundImage = "url('Resources/Image/gif.gif')";
    $('body').append('<embed src="/home/dell/PapapumProject/Resources/Sound/iggy_was_found.mp3" autostart="true" hidden="true" loop="false">');
    $('body').css('background-image', 'Resources/Image/gif.gif');
